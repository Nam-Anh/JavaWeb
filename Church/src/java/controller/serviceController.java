...
public class serviceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Initialize one ServiceDAO instance to get data from the database
            ServiceDAO sd = new ServiceDAO();
            //Get total number of Service in database to process paging
            int totalRows = sd.getNumberOfService();
            ...
            //Initialize one ServiceDao instance to get data from the database
            sd = new ServiceDAO();
            //Get Service in database having the order from start to end
            ArrayList<Service> lService = sd.getList(start, end);
            //Log error
            Logger.getLogger(serviceController.class.getName()).log(Level.SEVERE, null, "");

            /*--------------------------------------------------------------------*/
            //Fetch these data to the home.jsp to display
            request.setAttribute("lists", lService);
